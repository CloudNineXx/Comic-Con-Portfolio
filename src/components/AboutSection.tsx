...
export function AboutSection() {
  return (
    <section id="about" className="py-16 bg-gradient-to-br from-yellow-300 via-yellow-400 to-amber-500 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <ScrollReveal direction="left" delay={200}>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 p-6 rounded-2xl border-8 border-black shadow-3xl transform rotate-2 hover:rotate-0 transition-all duration-500 hover:scale-105 group">
                ...
                {/* Comic book corner elements */}
                <div className="absolute -top-3 -left-3 w-8 h-8 bg-yellow-400 border-4 border-black rounded-full flex items-center justify-center transform rotate-45 group-hover:rotate-90 transition-transform duration-300">
                  <div className="w-2 h-2 bg-black rounded-full"></div>
                </div>
                <div className="absolute -top-3 -right-3 w-8 h-8 bg-red-500 border-4 border-black rounded-full flex items-center justify-center transform -rotate-45 group-hover:-rotate-90 transition-transform duration-300">
                  <div className="w-2 h-2 bg-black rounded-full"></div>
                </div>
                <div className="absolute -bottom-3 -left-3 w-8 h-8 bg-green-500 border-4 border-black rounded-full flex items-center justify-center transform -rotate-45 group-hover:rotate-90 transition-transform duration-300">
                  <div className="w-2 h-2 bg-black rounded-full"></div>
                </div>
                <div className="absolute -bottom-3 -right-3 w-8 h-8 bg-blue-500 border-4 border-black rounded-full flex items-center justify-center transform rotate-45 group-hover:-rotate-90 transition-transform duration-300">
                  <div className="w-2 h-2 bg-black rounded-full"></div>
                </div>
                
                {/* Comic action lines */}
                <div className="absolute -top-6 -right-8 opacity-70 group-hover:opacity-100 transition-opacity">
                  <div className="w-12 h-1 bg-yellow-400 transform rotate-45 animate-pulse"></div>
                  <div className="w-10 h-1 bg-orange-500 transform rotate-45 mt-1 animate-pulse delay-150"></div>
                  <div className="w-8 h-1 bg-red-500 transform rotate-45 mt-1 animate-pulse delay-300"></div>
                </div>
                
                {/* Main image container */}
                <div className="relative overflow-hidden rounded-xl bg-white border-4 border-black">
                  ...
                  <div className="relative w-full h-[32rem] overflow-hidden rounded-lg">
                    {/* Default image */}
                    <img
                      src={profileImage}
          ...
          {/* Right side - Clean Comic Styled Content */}
          <ScrollReveal direction="right" delay={300}>
            <div className="space-y-6">
              {/* What I Do - Simplified Comic Card */}
              <div className="relative">
                  ...
                  <div className="bg-white rounded-xl p-4">
                    <div className="mb-4">
                      <div className="bg-red-600 text-white px-4 py-2 rounded-xl border-2 border-black inline-block transform -rotate-1">
                        <h3 className="typography-heading-sm text-white">🎯 What I Do</h3>
                      </div>
                    </div>
                    
                    <div className="space-y-3">
                      <p className="typography-body leading-relaxed text-gray-800">
                        I am a dedicated technology professional with a passion for learning and applying new technologies.
                      </p>
                      <p className="typography-body leading-relaxed text-gray-800">
              ...
              {/* Digital Explorations - Simplified Comic Card */}
              <div className="relative">
                  ...
                  <div className="bg-white rounded-xl p-3">
                    <div className="mb-3">
                      <div className="bg-blue-600 text-white px-3 py-1.5 rounded-xl border-2 border-black inline-block transform rotate-1">
                        <h3 className="typography-heading-sm text-white">🎬 Digital Explorations</h3>
                      </div>
                    </div>
                    
                    <div className="space-y-2 mb-3">
                      <p className="typography-body-sm leading-snug text-gray-800">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <a 
                        ...
                        className="group relative bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1.5 rounded-lg border-2 border-black font-black text-sm transform hover:scale-110 hover:-rotate-2 transition-all duration-300 shadow-sm hover:shadow-md comic-cursor-pow"
                      >
