        ...
        <div className="space-y-6">
          ...
          <ScrollReveal direction="up" delay={300}>
            <div className="flex flex-wrap justify-center gap-3">
              <Badge className="bg-gradient-to-r from-red-600 to-red-800 text-white px-4 py-2 typography-body-lg font-bold border-2 border-white transform rotate-1 hover:rotate-0 transition-transform shadow-lg">
                Systems & Technology Executive
              </Badge>
              <Badge className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-4 py-2 typography-body-lg font-bold border-2 border-white transform -rotate-1 hover:rotate-0 transition-transform shadow-lg">
                Gen AI Enthusiast
              </Badge>
              <Badge className="bg-gradient-to-r from-green-600 to-green-800 text-white px-4 py-2 typography-body-lg font-bold border-2 border-white transform rotate-1 hover:rotate-0 transition-transform shadow-lg">
          ...
          <ScrollReveal direction="up" delay={400}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-red-600 to-red-800 p-4 rounded-lg border-4 border-white transform hover:scale-105 transition-transform shadow-xl">
                ...
                <p className="typography-heading-lg text-yellow-400 text-comic-shadow font-bold">1.7M+</p>
                <p className="typography-body text-white font-bold">YouTube Impressions</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-4 rounded-lg border-4 border-white transform hover:scale-105 transition-transform shadow-xl">
                ...
                <p className="typography-body text-white font-bold">Years Creating</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-800 p-4 rounded-lg border-4 border-white transform hover:scale-105 transition-transform shadow-xl">
                ...
                <p className="typography-heading-lg text-yellow-400 text-comic-shadow font-bold">250K+</p>
                <p className="typography-body text-white font-bold">Views Generated</p>
              </div>
            </div>
          </ScrollReveal>
